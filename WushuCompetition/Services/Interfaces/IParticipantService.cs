...
namespace WushuCompetition.Services.Interfaces
{
    public interface IParticipantService
    {
        ...
        Task<IEnumerable<Participant>> GetParticipantsWhoDidNotCompete(Guid categoryId, Guid competitionId);
        Task<Guid> GetParticipantLowestWeight(Guid matchId);
        Task SetMatchLooser(Guid matchId, Guid winnerId);
    }
}
